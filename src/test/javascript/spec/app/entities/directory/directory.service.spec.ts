...
import { IDirectory, Directory } from 'app/shared/model/directory.model';
...
describe('Service Tests', () => {
    describe('Directory Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DirectoryService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new Directory(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false, currentDate);
        });
